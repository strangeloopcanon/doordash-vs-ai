...
## Key Findings
- Baseline DoorDash surfacing rate at rating_weight=0.00: **7.0%**
- Rating weight needed to reach >=10% surfacing: **not reached**
- Rating weight needed to reach >=20% surfacing: **not reached**
- Rating weight needed to 2x baseline: **not reached**
- Peak surfacing observed: **9.0%** at rating_weight=**0.20**
